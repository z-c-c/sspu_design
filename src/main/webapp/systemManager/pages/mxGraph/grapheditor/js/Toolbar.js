...
Toolbar.prototype.init = function()
{
	...
	var viewMenu = this.addMenu('', mxResources.get('zoom') + '视图 (Alt+Mousewheel)', true, 'viewZoom', null, true);
	...
	if (sw >= 420)
	{
		...
		elts[0].setAttribute('title',  '放大 (' + this.editorUi.actions.get('zoomIn').shortcut + ')');
		elts[1].setAttribute('title',  '缩放 (' + this.editorUi.actions.get('zoomOut').shortcut + ')');
	...
	elts[1].setAttribute('title', '撤销 (' + this.editorUi.actions.get('undo').shortcut + ')');
	elts[2].setAttribute('title', '下一步 (' + this.editorUi.actions.get('redo').shortcut + ')');
	
	if (sw >= 320)
	{
		var elts = this.addItems(['-', 'delete']);
		// elts[1].setAttribute('title', mxResources.get('delete') + ' (' + this.editorUi.actions.get('delete').shortcut + ')');
		elts[1].setAttribute('title', '删除 (' + this.editorUi.actions.get('delete').shortcut + ')');
	}
	...
	if (sw >= 400)
	{
		...
		if (sw >= 440)
		{
			...
			this.edgeShapeMenu = this.addMenuFunction('','箭头', false, mxUtils.bind(this, function(menu)
			{
				...
				this.editorUi.menus.edgeStyleChange(menu, '', [mxConstants.STYLE_SHAPE, 'width'], [null, null], 'geIcon geSprite geSprite-connection', null, true).setAttribute('title', '箭头');
			}));
		...
		//连接点
		this.edgeStyleMenu = this.addMenuFunction('geSprite-orthogonal', '连接线', false, mxUtils.bind(this, function(menu)
		...
		{
			this.editorUi.menus.edgeStyleChange(menu, '', [mxConstants.STYLE_EDGE, mxConstants.STYLE_CURVED, mxConstants.STYLE_NOEDGESTYLE], [null, null, null], 'geIcon geSprite geSprite-straight', null, true).setAttribute('title', "直线"/*mxResources.get('straight')*/);
			this.editorUi.menus.edgeStyleChange(menu, '', [mxConstants.STYLE_EDGE, mxConstants.STYLE_CURVED, mxConstants.STYLE_NOEDGESTYLE], ['orthogonalEdgeStyle', null, null], 'geIcon geSprite geSprite-orthogonal', null, true).setAttribute('title', "折线"/*mxResources.get('orthogonal')*/);
			...
			this.editorUi.menus.edgeStyleChange(menu, '', [mxConstants.STYLE_EDGE, mxConstants.STYLE_CURVED, mxConstants.STYLE_NOEDGESTYLE], ['orthogonalEdgeStyle', '1', null], 'geIcon geSprite geSprite-curved', null, true).setAttribute('title', "曲线"/*mxResources.get('curved')*/);
...
Toolbar.prototype.createTextToolbar = function()
{
	...
	// elts[1].setAttribute('title',  '撤销 (' + this.editorUi.actions.get('undo').shortcut + ')');
	// elts[2].setAttribute('title',  '下一步 (' + this.editorUi.actions.get('redo').shortcut + ')');
	// elts[4].setAttribute('title',  '加粗(' + this.editorUi.actions.get('bold').shortcut + ')');
	// elts[5].setAttribute('title',  '斜体(' + this.editorUi.actions.get('italic').shortcut + ')');
	// elts[6].setAttribute('title',  '下划线 (' + this.editorUi.actions.get('underline').shortcut + ')');
