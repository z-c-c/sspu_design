...
Menus.prototype.init = function () {
    ...
    this.put('save', new Menu(mxUtils.bind(this, function (menu, parent) {
        this.addMenuItem(menu, '提交', parent);
    })));
...
Menus.prototype.addMenuItem = function (menu, key, parent, trigger, sprite, label) {
    ...
    if (action != null && (menu.showDisabled || action.isEnabled()) && action.visible) {
        if (key == 'delete') {
            ...
            label = '逆转方向';
        } else if (key == 'customZoom') {
            label = '自定义缩放';
        } else if (key == 'resetView') {
            label = '重置视图';
        } else if (key == 'fitWindow') {
            label = '适应窗口';
        } else if (key == 'fitPageWidth') {
            label = '适应页面宽度';
        } else if (key == 'fitPage') {
            label = '适应一页';
        } else if (key == 'fitTwoPages') {
            label = '适应两页';
        } else if (key == 'selectVertices') {
            label = '选择顶点';
        } else if (key == 'selectEdges') {
            label = '选择关系';
        } else if (key == 'selectAll') {
            label = '全选';
        } else if (key == 'setAsDefaultStyle') {
            return null;
        } else if (key == 'editLink') {
            return null;
        } else if (key == 'clearWaypoints') {
            return null;
        } else if (key == 'removeWaypoint') {
            return null;
        } else if (key == 'addWaypoint') {
            return null;
        } else if (key == 'clearDefaultStyle') {
            return null;
        }
