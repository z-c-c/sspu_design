...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	 	...
	 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;', 120, 60, '', '类', null, null, 'rect rectangle box'),
	 	// this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;', 120, 60, '', 'Rounded Rectangle', null, null, 'rounded rect rectangle box'),
	 	// this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;', 120, 60, '', '关系', null, null, 'rounded rect rectangle box'),
	 	this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;', 80, 80, '', '关系',  null, null, 'diamond rhombus if condition decision conditional question test'),
	 	// this.createVertexTemplateEntry('shape=hexagon;perimeter=hexagonPerimeter2;whiteSpace=wrap;html=1;', 120, 80, '', '函数', null, null, 'hexagon preparation'),
	 	// this.createVertexTemplateEntry('shape=parallelogram;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;', 120, 60, '', '公理'),
		...
		// 	'Textbox', null, null, 'text textbox textarea'),
 		// this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 120, 80, '', '函数', null, null, 'oval ellipse state'),
		// this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', '公理', null, null, 'square'),
		// this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', '实例', null, null, 'circle'),
	...
	this.addPaletteFunctions('general', '本体构建', (expand != null) ? expand : true, fns);
};
