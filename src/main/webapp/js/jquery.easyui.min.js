...
},beforePageText:"第",afterPageText:"页/共 {pages}页",displayMsg:"当前从 第 {from} 项 至 第 {to} 项，共 {total} 项",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:36,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_389){
...
bc.append("<a href=\"javascript:void(0)\" class=\"textbox-icon "+bb[i].iconCls+"\" icon-home=\""+i+"\" tabindex=\"-1\"></a>");
}
}
...
if(icon.length){
var _4d8=parseInt(icon.attr("icon-home"));
...
$(_579).find(".calendar-title span").html(opts.year+"年 "+opts.months[opts.month-1]);
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["日", "一", "二", "三", "四", "五", "六"],months:["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
function _63b(tr){
if(tr.attr("datagrid-row-home")){
return parseInt(tr.attr("datagrid-row-home"));
}else{
...
for(var i=0;i<rows.length;i++){
_798.push("<tr class=\"datagrid-row\" datagrid-row-home=\""+i+"\">");
...
_79e.push("<tr id=\""+_7a2+"\" datagrid-row-home=\""+_79a+"\" "+cls+" "+_7a1+">");
...
var tr="<tr id=\""+_7ca+"\" class=\"datagrid-row\" datagrid-row-home=\""+_7c0+"\"></tr>";
if(_7c0>=data.rows.length){
if(data.rows.length){
...
tr.removeClass("datagrid-row").removeAttr("datagrid-row-home");
...
if(!tr.length){
tr=(_7e0==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home="+_7df+"]");
}
return tr;
}else{
if(type=="footer"){
return (_7e0==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-home="+_7df+"]");
}else{
if(type=="selected"){
...
if(type=="last"){
return (_7e0==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home]:last");
}else{
if(type=="allbody"){
return (_7e0==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-home]");
}else{
if(type=="allfooter"){
return (_7e0==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-home]");
}
}
}
}
...
var _7e3=(typeof p=="object")?p.attr("datagrid-row-home"):p;
...
var _81e=parseInt($(this).attr("datagrid-row-home"));
...
var _830=[];
_830.push("<div class=\"datagrid-group\" group-home="+_82b+">");
...
_830.push("<tr id=\""+_835+"\" datagrid-row-home=\""+_831+"\" "+cls+" "+_834+">");
...
if(_839.length){
var _83a=_839.closest("div.datagrid-group").attr("group-home");
...
var _846=view.find(_845!=undefined?"div.datagrid-group[group-home=\""+_845+"\"]":"div.datagrid-group");
...
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _849=view.find(_848!=undefined?"div.datagrid-group[group-home=\""+_848+"\"]":"div.datagrid-group");
...
var span=dc.body2.children("div.datagrid-group[group-home="+_84c+"]").find("span.datagrid-group-title");
...
var _85b=parseInt(tb.prev().attr("group-home"));
...
var _85f=parseInt(tb.prev().attr("group-home"));
...
body.children("div.datagrid-group[group-home="+_85f+"]").remove();
for(var i=_85f+1;i<this.groups.length;i++){
body.children("div.datagrid-group[group-home="+i+"]").attr("group-home",i-1);
}
...
var _945=[];
_945.push("<div class=\"datagrid-group\" group-home="+_940+">");
if(!_942){
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_968,keydown:_96c,paste:_96c,drop:_96c},panelWidth:null,panelHeight:"auto",panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:200,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
var _a1a=parseInt(tr.attr("datagrid-row-home"));
_a1a+=(dir=="next"?1:-1);
if(_a1a<0){
_a1a=_a19-1;
}
...
if(tr.length){
var _a32=parseInt(tr.attr("datagrid-row-home"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
...
var _a46=parseInt($(e.target).attr("datebox-button-home"));
...
$(function(){
	$(".tad-scroll").hide();
	$(".table-addmenu-dropdown b").click(function(){
		if($(".table-addmenu-dropdown b").hasClass("active")){
