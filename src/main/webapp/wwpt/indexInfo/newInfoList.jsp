...
<head>
    ...
    <script result="text/javascript" src="wwpt/js/getParameter.js"></script>
    <style>
        .labelBox {
            max-width: 380px;
            top: 15px;
    ...
    <script result="text/javascript">
        ...
        function searchOneKey(pageNum) {
            if (searchKey == null || searchKey == undefined || searchKey == "") {
                window.location = 'wwpt/shell.jsp'
            }
                    ...
                    if (res.code == "200") {
                        ...
                        for (var i = 0; i < contentArr.length; i++) {
                            ...
                            if ("event" == result) {
                                ...
                                var personImage = objectInfo.personImage == null || objectInfo.personImage == "" ? "wwpt/images/people.png" : contentArr[i].personImage;
        ...
        function goDetailPage(id, result, objName) {
            if ('person' == result) {
                window.open('wwpt/person/personDetail.jsp?paId=' + id + '', 'newwindow');
            } else if ('event' == result) {
                window.open("wwpt/event/eventDetail.jsp?eventId=" + id + "&eventName=" + objName);
            } else if ('unit' == result) {
                window.open('wwpt/person/personDetail.jsp?paId=' + id + '', 'newwindow');
            }
