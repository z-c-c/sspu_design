...
//弹框  - 特此标记（此处修改了position:"absolute"）
$(e.data.target).css({position:"fixed",left:e.data.left,top:e.data.top});
_52();
}
...
//开关  - 特此标记（此处修改了width:60,height:30）
$.fn.switchbutton.defaults={handleWidth:"auto",width:40,height:20,checked:false,disabled:false,readonly:false,reversed:false,onText:"ON",offText:"OFF",handleText:"",value:"on",onChange:function(_4ee){
}};
})(jQuery);
(function($){
var _4ef=1;
...
//单选radio尺寸 - 特此标记（此处修改了width:20,height:20,labelPosition:"before"）
$.fn.radiobutton.defaults={width:14,height:14,value:null,disabled:false,checked:false,label:null,labelWidth:"auto",labelPosition:"after",labelAlign:"left",onChange:function(_50f){
}};
})(jQuery);
(function($){
var _510=1;
...
//单选radio尺寸 - 特此标记（此处修改了width:20,height:20,labelPosition:"before"）
$.fn.checkbox.defaults={width:14,height:14,value:null,disabled:false,checked:false,label:null,labelWidth:"auto",labelPosition:"after",labelAlign:"left",onChange:function(_531){
}};
})(jQuery);
(function($){
function init(_532){
